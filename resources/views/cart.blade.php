        ...
        <div>
          ...
          @if (Cart::count() > 0)
            ...
            @foreach(Cart::content() as $item)
                <div class="cart-table-row">
                    ...
                    <div class="cart-table-row-left">
                        ...
                        <a href="{{route('shop.show',$item->model->slug)}}"><img src="{{asset('storage/'.$item->model->images)}}" alt="item" class="cart-table-img"></a>
                    ...
                    <div class="cart-table-row-right">
                       ...
                       {{-- <div>${{number_format($item->model->price)}}</div> --}}
            ...
            <div class="cart-totals">
                ...
                {{-- ${{number_format($item->model->sum('price'))}} <br> --}}
           ...
           @if(Cart::instance('switchtosaveforlater')->count() > 0)
            ...
            @foreach (Cart::instance('switchtosaveforlater')->content() as $item) 
                <div class="cart-table-row">
                    <div class="cart-table-row-left">
                        <a href="#"><img src="{{asset('storage/'.$item->model->images)}}" alt="item" class="cart-table-img"></a>
                        <div class="cart-item-details">
                            <div class="cart-table-item"><a href="#">{{ $item->model->name }}</a></div>
                            <div class="cart-table-description">{{ $item->model->details }}</div>
                        </div>
