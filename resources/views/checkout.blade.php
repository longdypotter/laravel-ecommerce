            ...
            <div class="checkout-table-container">
                ...
                @foreach (Cart::content() as $item)
                    <div class="checkout-table-row">
                        <div class="checkout-table-row-left">
                            <img src="{{asset('storage/'.$item->model->images)}}" alt="item" class="checkout-table-img">
                ...
                <div class="checkout-totals">
                    <div class="checkout-totals-left">
                        ...
                        @endif
                        Tax <br>
                        <span class="checkout-totals-total" style="font-size:14px">Total</span>
                ...
                <a href="#" class="have-code">Have a Code?</a>
                    ...
                    <form action="{{route('coupon.store')}}" method="POST">
                        {{ csrf_field() }}
                        <input type="text" name="coupon_code" id="coupon_code" style="margin-top:10px;">
